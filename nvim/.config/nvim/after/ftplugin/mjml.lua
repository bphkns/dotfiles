      ...
      customData = {
        {
          ...
          tags = {
            ...
            { name = "mj-body", attributes = { { name = "background-color" }, { name = "css-class" }, { name = "width" } } },
            { name = "mj-section", attributes = { { name = "background-color" }, { name = "padding" }, { name = "css-class" } } },
            { name = "mj-column", attributes = { { name = "width" }, { name = "padding" }, { name = "css-class" } } },
            { name = "mj-group", attributes = { { name = "width" }, { name = "css-class" } } },
            { name = "mj-wrapper", attributes = { { name = "background-color" }, { name = "padding" }, { name = "css-class" } } },
            
            -- Content components
            { name = "mj-text", attributes = { { name = "color" }, { name = "font-size" }, { name = "align" }, { name = "css-class" } } },
            { name = "mj-button", attributes = { { name = "href" }, { name = "background-color" }, { name = "color" }, { name = "css-class" } } },
            { name = "mj-image", attributes = { { name = "src" }, { name = "alt" }, { name = "width" }, { name = "css-class" } } },
            { name = "mj-divider", attributes = { { name = "border-color" }, { name = "border-width" }, { name = "css-class" } } },
            ...
            { name = "mj-navbar-link", attributes = { { name = "href" }, { name = "color" }, { name = "css-class" } } },
            
            -- Social
            { name = "mj-social", attributes = { { name = "mode" }, { name = "css-class" } } },
            { name = "mj-social-element", attributes = { { name = "href" }, { name = "name" }, { name = "css-class" } } },
            
            -- Media
            { name = "mj-hero", attributes = { { name = "background-url" }, { name = "background-color" }, { name = "css-class" } } },
            { name = "mj-carousel", attributes = { { name = "css-class" } } },
            { name = "mj-carousel-image", attributes = { { name = "src" }, { name = "alt" }, { name = "css-class" } } },
...
vim.keymap.set('n', '<leader>mv', function()
  ...
  if vim.v.shell_error == 0 then
    ...
    if #qf_list > 0 then
      ...
      vim.cmd('copen')
      vim.notify('MJML validation errors found. Check quickfix list.', vim.log.levels.ERROR, { title = 'MJML Validation' })
    else
...
vim.keymap.set('n', '<leader>mc', function()
  ...
  local output = vim.fn.system(cmd)
  if vim.v.shell_error == 0 then
    vim.notify('MJML compiled successfully to ' .. vim.fn.fnamemodify(output_file, ':t'), vim.log.levels.INFO, { title = 'MJML Compile' })
  else
  ...
  callback = function()
    ...
    if vim.fn.executable('mjml') == 1 then
      vim.defer_fn(function()
        ...
        if vim.v.shell_error ~= 0 then
          vim.notify('MJML validation failed on save. Use <leader>mv for details.', vim.log.levels.WARN, { title = 'MJML Validation' })
        end
